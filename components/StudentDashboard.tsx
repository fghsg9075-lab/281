              ...
              <div className="space-y-6 pb-24">
                      ...
                      <div className="bg-purple-50 p-4 rounded-2xl border border-purple-100">
                          <div className="flex justify-between items-center mb-2">
                              ...
                              <button 
                                  onClick={() => {
                                      const questions: MCQItem[] = Array.from({ length: 100 }, (_, i) => ({
                                          question: `Daily Challenge Question ${i + 1}`,
                                      ...
                                      const test: WeeklyTest = {
                                          ...
                                          name: "Daily Challenge (100 Qs)",
                                          description: "Solve 100 Questions in 15 Minutes. Score 90% to win 1 Month Free Subscription!",
                                          isActive: true,
                                          classLevel: user.classLevel || '10',
                                          questions: questions,
                                          totalQuestions: 100,
